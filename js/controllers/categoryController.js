...
document.addEventListener("DOMContentLoaded", () => {
    ...
    loadCategories(); //Despues de cargar las constantes, cargamos las 
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try{
            //Si existe el id el metodo a utilizar es el update
            if(id){
                await updateCategory(id, data);
            }
            //Si no existe el id el metodo a utilizar es el create
            else{
    ...
    async function loadCategories() {
        try{
            ...
            tableBody.innerHTML = ''; //Vaciamos el tableBody
            ...
            categories.forEach((cat)=>{
                const tr = document.createElement("tr"); //Definimos en TR en JS
                tr.innerHTML = `
                ...
                //Funcionalidad para el boton de eliminar categoria
                ...
                tableBody.appendChild(tr); //Al tableBody le agrega el <tr> creado
            });
        }
        catch(err){
